...
with DAG(
    ...
    def load_quotes(**kwargs):
        ...
        for quote in quotes:
            cursor.execute(insert_query, (quote['quote_id'], quote['quote_content'], quote['quote_url'], quote['quote_language'], quote['originator_id'], quote['originator_name'], quote['originator_url'], quote['tags']))
